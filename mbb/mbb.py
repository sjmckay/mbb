...
class ModifiedBlackbody:
    ...
    or updated as needed, and various parameters/statistics can be extracted. The models are based off of `Casey (2012) <https://doi.org/10.1111/j.1365-2966.2012.21455.x>`_.
    ...
    Args:
        ...
        pl_piecewise (bool): if the powerlaw should be attached piecewise (as in Drew&Casey 2022) or with exponential fall-off (as in Casey+ 2012). 
