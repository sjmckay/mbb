...
#plot initial models
m1 = MBB(L=12, T=45, z=2.5, beta=1.8, alpha=2.0, pl=True, opthin=False, pl_piecewise=False)
m1.plot_sed()
plt.title('m1')

m2 = MBB(L=12, T=45, z=2.5, beta=1.8, alpha=2.0, pl=True, opthin=True, pl_piecewise=True)
m2.plot_sed()
plt.title('m2')
...
m3 = MBB(L=12, T=45, z=2.5, beta=1.8, alpha=2.0, pl=True, opthin=False, pl_piecewise=False)
m3.fit(phot, niter=100, nwalkers=50, ncores=1, params=['L','T'])
m3.plot_sed()
plt.title('m3')

m4 = MBB(L=12, T=45, z=2.5, beta=1.8, alpha=2.0, pl=True, opthin=True, pl_piecewise=False)
